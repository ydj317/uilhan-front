<template>
  <div class="tinymce-box">
    <Editor v-model="contentValue" :init="init" :disabled="disabled" @onClick="onClick" @change="selectionChange"/>
  </div>
</template>
  ...
  data(){
    return {
      init: {
        ...
        content_style: "img {max-width:100%;} p {display: flex; flex-flow: row nowrap; align-items: center;}",  //直接自定义可编辑区域的css样式
