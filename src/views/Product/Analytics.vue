            ...
            <a-descriptions-item label="계정">
                <div>
                    ...
                    <a-checkbox-group v-model:value="state.tableData.params.market">
                        <a-checkbox v-for="(item, key) in state.marketList" :key="key" :value="key">{{ item }}
                        </a-checkbox>
                    </a-checkbox-group>
                </div>
            </a-descriptions-item>
        ...
        <a-table :columns="tableColumns" :data-source="tableList" bordered :pagination="false">
            ...
            <template #bodyCell="{ column, record }">
                ...
                <template v-if="column.key === 'chart'">
                    <img src="../../assets/img/404.jpg" width="20" height="20" @click="modalChart"
            ...
            option = {
                ...
                series: [
                    ...
                    },
                    {
                        ...
                        type: 'line',
                        stack: 'Total',
                        data: [320, 332, 301, 334, 390, 330, 420]
                    }
                ]
            };
