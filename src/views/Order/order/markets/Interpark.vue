<template>
  ...
  <a-descriptions title="결제정보" bordered :column="2" class="mt40" :labelStyle="{ width: '220px' }" :contentStyle="{ width: '500px' }">
    ...
    <a-descriptions-item label="결제일시">{{ moment(orderData.orgData?.PAY_DTS, "YYYYMMDDHHmmss").format('YYYY-MM-DD') }}</a-descriptions-item>
  </a-descriptions>
  ...
  <a-descriptions title="주문자 정보" bordered :column="2" class="mt40" :labelStyle="{ width: '220px' }" :contentStyle="{ width: '500px' }">
    ...
    <a-descriptions-item label="주문자 ID">{{ orderData.orgData.MEM_ID }}</a-descriptions-item>
    <a-descriptions-item label="주문자 연락처">{{ orderData.orgData.MOBILE_TEL }}</a-descriptions-item>
  </a-descriptions>
  ...
  <a-descriptions title="수령자 정보" bordered :column="2" class="mt40" :labelStyle="{ width: '220px' }"
    ...
    <a-descriptions-item label="수령자 연락처 1">{{ orderData.receiverTel1 }}</a-descriptions-item>
    ...
    <a-descriptions-item label="상세 주소">{{ orderData.receiverAddr2 }}
    </a-descriptions-item>

    <a-descriptions-item label="개인통관번호">{{ orderData.personalCustomsClearanceCode }}
    </a-descriptions-item>
  </a-descriptions>
  ...
  <a-descriptions title="상품 정보" bordered :column="2" class="mt40" :labelStyle="{ width: '220px' }"
    ...
    <a-descriptions-item label="배송비" >{{ orderData.orgData?.DELIVERY_DETAIL?.PRD_DELV?.DELV_AMT }}</a-descriptions-item>
