<template>
  ...
  <a-descriptions title="주문자 정보" bordered :column="2" class="mt40" :labelStyle="{ width: '220px' }" :contentStyle="{ width: '500px' }">
    ...
    <a-descriptions-item label="주문자 ID">{{ orderData.orgData.userId }}</a-descriptions-item>
  ...
  <a-descriptions title="수령자 정보" bordered :column="2" class="mt40" :labelStyle="{ width: '220px' }"
    ...
    <a-descriptions-item label="수령자 연락처 1">{{ orderData.orgData.receiverPhone }}</a-descriptions-item>
    ...
    <a-descriptions-item label="상세 주소">{{ orderData.orgData.receiverAddress.addressDetail }}
    </a-descriptions-item>
  ...
  <a-descriptions title="상품 정보" bordered :column="2" class="mt40" :labelStyle="{ width: '220px' }"
    ...
    <a-descriptions-item label="배송비" >{{ orderData.itemOrgData.deliveryFee.userAmount }}</a-descriptions-item>
  ...
  <a-descriptions title="배송 정보" bordered :column="2" class="mt40" :labelStyle="{ width: '220px' }"
    ...
    <a-descriptions-item label="배송메모" >{{ orderData.orgData.deliveryMemo }}</a-descriptions-item>
  </a-descriptions>
</template>
