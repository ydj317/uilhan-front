  ...
  <a-card :bordered="false" title="주문관리" :style="{marginBottom:'20px'}">
    ...
    <div class="inline-block mr17">
      ...
      <a-input-group compact>
        ...
        <a-input v-model:value="searchParam.numberValue" style="width: 300px;" />
      </a-input-group>
    </div>
    ...
    <div class="inline-block">
      ...
      <a-input-group compact>
        ...
        <a-input v-model:value="searchParam.nameValue" style="width: 300px;" />
      </a-input-group>
    </div>
    ...
    <div class="inline-block mt20">
      ...
      <a-select v-model:value="searchParam.orderFrom" mode="tags" placeholder="주문상태를 선택해주시오"
        ...
        <a-select-option v-for="option in siteOptions" :value="option.value">
          ...
          <div v-else>
            <span class="item-market-icon">
              <img :src="getLogoSrc('market-logo', option.value.split('::')[0])" alt="">
            </span>
...
function handleStatusChange(value) {
  if (value.includes("all")) {
    searchParam.value.status = statusOptions
...
function handleOrderFromChange(value) {
  if (value.includes("all")) {
    searchParam.value.orderFrom = siteOptions
      .filter(option => option.value !== "all")
      .map(option => option.value);
...
.inline-block .ant-picker-input input {
  text-align: center;
}
</style>
