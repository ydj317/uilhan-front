...
(function (e, t) {
    ...
    r = x(a), function (e, t) {
        ...
        s = at.isXML = function (e) {
            ...
            cacheLength: 50, createPseudo: lt, match: Q, attrHandle: {}, find: {}, relative: {
    ...
    x.fn.extend({
        ...
        cssHooks: {
            ...
            zIndex: !0,
            zoom: !0
        }, cssProps: {"float": x.support.cssFloat ? "cssFloat" : "styleFloat"}, style: function (e, n, r, i) {
        ...
        active: 0, lastModified: {}, etag: {}, ajaxSettings: {
            ...
            function k(e, n, r, i) {
                ...
                2 !== b && (b = 2, s && clearTimeout(s), u = t, a = i || "", C.readyState = e > 0 ? 4 : 0, c = e >= 200 && 300 > e || 304 === e, r && (w = Mn(p, C, r)), w = On(p, w, C, c), c ? (p.ifModified && (T = C.getResponseHeader("Last-Modified"), T && (x.lastModified[o] = T), T = C.getResponseHeader("etag"), T && (x.etag[o] = T)), 204 === e || "HEAD" === p.type ? N = "nocontent" : 304 === e ? N = "notmodified" : (N = w.state, y = w.data, v = w.error, c = !v)) : (v = N, (e || !N) && (N = "error", 0 > e && (e = 0))), C.status = e, C.statusText = (n || N) + "", c ? h.resolveWith(f, [
                    ...
                    C, p, c ? y : v
                ]), g.fireWith(f, [C, N]), l && (d.trigger("ajaxComplete", [
                    C, p
    ...
    if (e['_$'] === undefined) {
        e['_$'] = x;
    } else if (e['_jQuery'] === undefined) {
        e['_jQuery'] = x;
    } else {
        alert('`_$` , `_jQuery` 已被占用')
    }

    if ($oTempJquery !== undefined) {
        e['$'] = $oTempJquery
    }
})(window);
